...
<jsp:include page="include/header_middle.jsp"></jsp:include>
    ...
    <div class="box_ketqua" id="test_ketqua" style="position: relative; top: 0px; bottom: 0px; left: 0px; right: 0px; margin-top: 0px;">
        <div class="head">
            <a class="check" href="javascript:checkAswer()" id="test_result" onclick="return checkAswer()"><i></i><span>Chấm điểm</span></a>
        ...
        <div class="list" style="height: 420px;">
            ...
            <div class="scrollbar-inner" id="fulltest_question_shortcut">
            		...
            		<tr>
	            		...
	            		<td>A.<input  type="radio" name="question[<%=i %>]" value="A">&nbsp&nbsp&nbsp</td>
	            		<td>B.<input  type="radio" name="question[<%=i %>]" value="B">&nbsp&nbsp&nbsp</td>
	            		<td>C.<input  type="radio" name="question[<%=i %>]" value="C">&nbsp&nbsp&nbsp</td>
	            		<td>D.<input  type="radio" name="question[<%=i %>]" value="D">&nbsp&nbsp</td>
	            		</tr>
            		</c:if>
            		<c:if test="${item.part==3}">
	            		<tr>
